...
export class FinancialDataOplEditComponent implements OnInit {
  ...
  calculateOperatingCost() {
    this.FinancialDataForm.patchValue({
      TotalOperatingCostAmt: this.FinancialDataForm.controls.TotalFeeCapitalizedAmt.value + this.FinancialDataForm.controls.TotalInsuranceAtCostAmt.value + this.FinancialDataForm.controls.TotalMaintenanceAtCostAmt.value + this.FinancialDataForm.controls.TotalExpenseAmt.value + this.FinancialDataForm.controls.InterestAmt.value + this.FinancialDataForm.controls.DepreciationAmt.value
    });
  }
  ...
  setAssetFinData() {
    ...
    var FinOplObj = {
      ...
      CustomerPaidAtCostAmt: this.FinancialDataForm.controls.CustomerPaidAtCostAmt.value,
      ResidualValuePrcnt: this.FinancialDataForm.controls.ResidualValuePrcnt.value,
      InterestPrnct: this.FinancialDataForm.controls.InterestPrnct.value,
      OperatingMarginPrcnt: this.FinancialDataForm.controls.OperatingMarginPrcnt.value,
      ...
      ListCashInCashOut: this.CalculatedObj.ListCashInCashOut
    };
    return FinOplObj;
  }
