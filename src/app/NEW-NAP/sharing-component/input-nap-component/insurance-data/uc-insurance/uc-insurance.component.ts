...
export class UcInsuranceComponent implements OnInit {
  ...
  SaveForm(saveObj: InsuranceDataObj) {
    if(this.isMultiAsset){
      if (saveObj.AppInsObjObj.AppInsObjId == 0) {
        this.http.post(URLConstant.AddInsuranceDataMultiAsset, saveObj).subscribe(
          (response) => {
            this.toastr.successMessage(response["Message"]);
            this.BindMultiInsGridData();
            this.PageState = 'Paging';
        ...
        this.http.post(URLConstant.EditInsuranceDataMultiAsset, saveObj).subscribe(
          (response) => {
            this.toastr.successMessage(response["Message"]);
            this.BindMultiInsGridData();
            this.PageState = 'Paging';
      ...
      this.http.post(URLConstant.AddEditInsuranceData, saveObj).subscribe(
        (response) => {
          this.toastr.successMessage(response["Message"]);
          this.outputTab.emit();
        });
