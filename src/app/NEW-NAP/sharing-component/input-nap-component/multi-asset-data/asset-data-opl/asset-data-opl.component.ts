      ...
      (response) => {
        ...
        if (this.appAssetObj != null) {
          for(let i = 0; i < this.appAssetObj.length; i++) {
            ...
            this.allAssetDataObj.AppAssetObj.AssetPriceAmt = this.appAssetObj[i].ResponseAppAssetObj.AssetPriceAmt;
            ...
            this.allAssetDataObj.AppAssetObj.Discount = this.appAssetObj[i].ResponseAppAssetObj.DiscountAmt;
