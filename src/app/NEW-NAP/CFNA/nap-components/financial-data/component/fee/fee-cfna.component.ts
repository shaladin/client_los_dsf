...
@Component({
  selector: 'app-fee-cfna',
  templateUrl: './fee-cfna.component.html',
  styleUrls: ['./fee-cfna.component.css']
})
export class FeeCFNAComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    if (this.AppId != null) {
      ...
      await this.LoadAppFeeDataForTrialCalc();
    }
  ...
  async LoadAppFeeDataForTrialCalc() {
    var reqObj = {
