...
@Component({
  ...
  templateUrl: './schm-step-up-step-down-cummulative-cfna.component.html',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class SchmStepUpStepDownCummulativeCFNAComponent implements OnInit {
  @Input() AppId: number;
  ...
  LoadCalcBaseType() {
    let tempReq: ReqRefMasterByTypeCodeAndMappingCodeObj = { RefMasterTypeCode: CommonConstant.RefMasterTypeCodeFinDataCalcBaseOn, MappingCode: "" };
