...
@Component({
  selector: 'app-applicant-existing-main-data-company',
  templateUrl: './applicant-existing-main-data-company.component.html',
  styleUrls: []
})
export class ApplicantExistingMainDataCompanyComponent implements OnInit {
