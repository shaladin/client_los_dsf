...
@Component({
  selector: 'app-nap-from-simple-lead-detail-dsf',
  templateUrl: './nap-from-simple-lead-detail-dsf.component.html',
  styleUrls: ['./nap-from-simple-lead-detail-dsf.component.css']
})
export class NapFromSimpleLeadDetailDsfComponent implements OnInit {
