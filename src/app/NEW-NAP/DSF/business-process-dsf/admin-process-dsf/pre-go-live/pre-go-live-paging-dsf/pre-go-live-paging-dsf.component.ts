...
@Component({
  selector: 'app-pre-go-live-paging-dsf',
  templateUrl: './pre-go-live-paging-dsf.component.html',
  styleUrls: ['./pre-go-live-paging-dsf.component.css']
})
export class PreGoLivePagingDsfComponent implements OnInit {
  ...
  GetCallBack(ev: any) {
    ...
    if (ev.Key == "ViewProdOffering") {
      ...
      AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.NAP_ADM_PRCS_PGL_DETAIL], { "AgrmntId": ev.RowObj.AgrmntId, "AppId": ev.RowObj.AppId, "TaskListId": wfTaskListIdTemp, "AgrmntNo": ev.RowObj.AgrmntNo, "BizTemplateCode": this.bizTemplateCode });
      // Self Custom CR MPF Validation
    }
  }
