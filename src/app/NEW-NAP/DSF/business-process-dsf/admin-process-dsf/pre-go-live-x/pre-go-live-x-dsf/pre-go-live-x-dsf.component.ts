...
@Component({
  selector: 'app-pre-go-live-x-dsf',
  templateUrl: './pre-go-live-x-dsf.component.html',
  styleUrls: ['./pre-go-live-x-dsf.component.css']
})
export class PreGoLiveXDsfComponent implements OnInit {
  ...
  readonly CancelLink: string = NavigationConstantDsf.NAP_ADM_PRCS_PGL_PAGING;
