...
@Component({
  selector: 'app-new-purchase-order-dsf',
  templateUrl: './new-purchase-order-dsf.component.html',
  styles: []
})
export class NewPurchaseOrderDsfComponent implements OnInit, OnDestroy {
  ...
  SetUcPaging() {
    ...
    if(environment.isCore){
      ...
      this.inputPagingObj._url = "./assets/dsf/ucpaging/V2/searchNewPurchaseOrderV2Dsf.json";
      this.inputPagingObj.pagingJson = "./assets/dsf/ucpaging/V2/searchNewPurchaseOrderV2Dsf.json";
