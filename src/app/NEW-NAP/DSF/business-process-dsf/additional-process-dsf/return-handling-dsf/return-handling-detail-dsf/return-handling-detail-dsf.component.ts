...
@Component({
  selector: 'app-return-handling-detail-dsf',
  templateUrl: './return-handling-detail-dsf.component.html'
})
export class ReturnHandlingDetailDsfComponent implements OnInit {
  appId: number;
  ...
  readonly CancelLink: string = NavigationConstantDsf.NAP_ADD_PRCS_RETURN_HANDLING_PAGING;
  ...
  async GetListReturnHandlingDByReturnHandlingHId() {
    const reqObj = {Id : this.returnHandlingHId};
