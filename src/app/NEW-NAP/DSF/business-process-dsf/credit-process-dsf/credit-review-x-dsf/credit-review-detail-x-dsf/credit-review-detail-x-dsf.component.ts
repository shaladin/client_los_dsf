...
@Component({
  ...
  templateUrl: './credit-review-detail-x-dsf.component.html',
  styleUrls: ['./credit-review-detail-x-dsf.component.css']
})
export class CreditReviewDetailXDsfComponent implements OnInit {
