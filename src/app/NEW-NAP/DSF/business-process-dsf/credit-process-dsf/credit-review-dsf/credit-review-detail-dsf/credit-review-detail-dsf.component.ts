...
@Component({
  ...
  templateUrl: './credit-review-detail-dsf.component.html',
  styleUrls: ['./credit-review-detail-dsf.component.css']
})
export class CreditReviewDetailDsfComponent implements OnInit {
