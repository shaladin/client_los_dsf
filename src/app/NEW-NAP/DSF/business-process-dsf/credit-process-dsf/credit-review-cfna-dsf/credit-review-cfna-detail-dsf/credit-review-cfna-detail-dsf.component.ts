...
@Component({
  ...
  templateUrl: './credit-review-cfna-detail-dsf.component.html',
  styleUrls: ['./credit-review-cfna-detail-dsf.component.css']
})
export class CreditReviewCfnaDetailDsfComponent implements OnInit {
