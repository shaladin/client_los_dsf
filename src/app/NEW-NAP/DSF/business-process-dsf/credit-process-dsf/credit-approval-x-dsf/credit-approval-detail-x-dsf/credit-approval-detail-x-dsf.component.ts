...
@Component({
  ...
  templateUrl: './credit-approval-detail-x-dsf.component.html',
  styleUrls: ['./credit-approval-detail-x-dsf.component.css']
})
export class CreditApprovalDetailXDsfComponent implements OnInit {
