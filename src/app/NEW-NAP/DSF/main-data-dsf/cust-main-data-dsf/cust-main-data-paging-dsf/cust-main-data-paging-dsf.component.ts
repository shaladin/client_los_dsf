...
@Component({
  selector: 'app-cust-main-data-paging-dsf',
  templateUrl: './cust-main-data-paging-dsf.component.html',
  styleUrls: ['./cust-main-data-paging-dsf.component.css']
})
export class CustMainDataPagingDsfComponent implements OnInit {
  ...
  AddApp() {
    ...
    this.http.post(URLConstant.GetRefOfficeByOfficeCode, {Code : this.userAccess.OfficeCode}).subscribe(
      (response) => {
        ...
        // }
        AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.NAP_MAIN_DATA_NAP1_ADD], { "BizTemplateCode": this.bizTemplateCode });
      });
  }
