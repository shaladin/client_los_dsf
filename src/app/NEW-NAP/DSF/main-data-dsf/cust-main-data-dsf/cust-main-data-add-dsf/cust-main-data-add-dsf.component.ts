...
@Component({
  ...
  templateUrl: './cust-main-data-add-dsf.component.html',
  styleUrls: ['./cust-main-data-add-dsf.component.css']
})
export class CustMainDataAddDsfComponent implements OnInit {
