...
@Component({
  selector: 'app-application-data-x-cf4w-dsf',
  templateUrl: './application-data-x-cf4w-dsf.component.html'
})
export class ApplicationDataXCf4wDsfComponent implements OnInit {
  ...
  async makeLookUpObj() {
    ...
    // End Self Custom Changes CR API Data Robot 413750
