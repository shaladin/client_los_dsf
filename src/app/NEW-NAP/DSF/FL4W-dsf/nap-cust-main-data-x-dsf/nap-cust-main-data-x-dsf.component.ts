...
@Component({
  selector: 'app-nap-cust-main-data-x-dsf',
  templateUrl: './nap-cust-main-data-x-dsf.component.html',
  styleUrls: ['./nap-cust-main-data-x-dsf.component.css']
})
export class NapCustMainDataXDsfComponent implements OnInit {
