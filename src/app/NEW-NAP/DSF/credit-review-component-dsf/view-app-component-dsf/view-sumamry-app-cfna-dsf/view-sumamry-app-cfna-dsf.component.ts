...
@Component({
  selector: 'app-view-sumamry-app-cfna-dsf',
  templateUrl: './view-sumamry-app-cfna-dsf.component.html',
  styleUrls: ['./view-sumamry-app-cfna-dsf.component.css']
})
export class ViewSumamryAppCfnaDsfComponent implements OnInit {
