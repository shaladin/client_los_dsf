...
@Component({
  selector: 'app-ro-potential-view-dsf',
  templateUrl: './ro-potential-view-dsf.component.html'
})
export class RoPotentialViewDsfComponent implements OnInit {
  ...
  gotoTelemkDetail() {
    AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.LEAD_POTENTIAL_RO_TEL_OFFER_VERIF], { "RoPotentialNo": this.roPotentialNo });
  }
