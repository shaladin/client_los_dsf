...
import { LeadCancelObj } from 'app/shared/model/lead-cancel-obj.model';
...
@Component({
  ...
  templateUrl: './lead-cancel-dsf.component.html'
})

export class LeadCancelDsfComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if(this.MrLeadTypeCode == CommonConstant.MrLeadTypeCodeSimpleLead) {
      this.tempPagingObj.urlJson = "./assets/dsf/ucpaging/ucTempPaging/SimpleLeadCancelTempPagingDsf.json";
      this.tempPagingObj.pagingJson = "./assets/dsf/ucpaging/ucTempPaging/SimpleLeadCancelTempPagingDsf.json";
