...
@Component({
  selector: 'app-third-party-form-x-dsf',
  templateUrl: './third-party-form-x-dsf.component.html',
  styleUrls: ['./third-party-form-x-dsf.component.css'],
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class ThirdPartyFormXDsfComponent implements OnInit {
  ...
  ViewTrustingSocial() {
    ...
    const modalRef = this.modalService.open(TrustingSocialViewHeaderXDsfComponent);
