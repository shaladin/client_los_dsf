...
@Component({
  selector: 'cessie-pre-go-live-paging-dsf',
  templateUrl: './pre-go-live-paging-dsf.component.html'
})
export class CessiePreGoLivePagingDsfComponent implements OnInit {
  ...
  GetCallBack(ev: any) {
    if (ev.Key == "ViewProdOffering") {
      ...
      AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.CESSIE_PGL_DETAIL], { "CessieHXId": ev.RowObj.CessieHXId, "CessieNo": ev.RowObj.CessieNo, "TaskListId": ev.RowObj.Id });
    }
  }
}
