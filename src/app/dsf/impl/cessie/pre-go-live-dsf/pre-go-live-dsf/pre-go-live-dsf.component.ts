...
@Component({
  selector: 'cessie-pre-go-live-dsf',
  templateUrl: './pre-go-live-dsf.component.html'
})
export class CessiePreGoLiveDsfComponent implements OnInit {
  ...
  readonly CancelLink: string = NavigationConstantDsf.CESSIE_PGL_PAGING;
  ...
  onChangeRefPayment()
  {
    ...
    if (this.FormObj.controls.RefPayment.value.match(regexFormat))
    {
