...
@Component({
  selector: 'cessie-pre-go-live-approval-paging-dsf',
  templateUrl: './pre-go-live-approval-paging-dsf.component.html'
})

export class CessiePreGoLiveApprovalPagingDsfComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (environment.isCore) {
      ...
      apvReqObj.CategoryCode = CommonConstantX.CESSIE_PRE_GPV_APV_CATEGORY;
      ...
      integrationObj.leftColumnToJoin = 'CessieNo';
  ...
  async GetCallBack(ev: any) {
    ...
    if (ev.Key == 'Process') {
      ...
      AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.CESSIE_PGL_APPRVL_DETAIL], {
        'CessieHXId': ev.RowObj.CessieHXId,
        ...
        'mrCustTypeCode': ev.RowObj.MrCustTypeCode
      });
