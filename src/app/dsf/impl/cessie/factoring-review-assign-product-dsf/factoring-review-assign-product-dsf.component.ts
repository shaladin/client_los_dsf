...
@Component({
  selector: 'app-factoring-review-assign-product-dsf',
  templateUrl: './factoring-review-assign-product-dsf.component.html',
  styleUrls: ['./factoring-review-assign-product-dsf.component.css']
})
export class FactoringReviewAssignProductDsfComponent implements OnInit {
  ...
  SaveForm() {
    ...
    this.http.post<GenericObj>(Url, obj).subscribe(
      (response) => {
        ...
        AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.CESSIE_FACTORING_REVIEW_DETAIL_DSF], { "CessieHXId": this.CessieHXId, "WfTaskListId": this.WfTaskListId, "CessieNo": this.CessieNo, "OfficeCode": this.OfficeCode, "OfficeName": this.OfficeName, "CustNo": this.CustNo, "CustId": this.CustId });
      }
    );
  }

  buttonCancelClick() {
    AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.CESSIE_FACTORING_REVIEW_PAGING_DSF], {});
  }
