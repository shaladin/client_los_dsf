...
@Component({
  selector: 'app-factoring-review-detail-dsf',
  templateUrl: './factoring-review-detail-dsf.component.html',
  styleUrls: ['./factoring-review-detail-dsf.component.css']
})
export class FactoringReviewDetailDsfComponent implements OnInit {

  readonly CancelLink: string = NavigationConstantDsf.CESSIE_FACTORING_REVIEW_PAGING_DSF;
    CessieHXId: number;
    ...
    SaveForm(enjiForm: NgForm) {
        ...
        this.httpClient.post(URLConstantDsf.SubmitReviewDsf, ObjDisbInfo).subscribe(
            (response) => {
