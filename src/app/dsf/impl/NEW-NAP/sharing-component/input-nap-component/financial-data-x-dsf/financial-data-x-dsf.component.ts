...
@Component({
  ...
  templateUrl: './financial-data-x-dsf.component.html',
  styleUrls: ['./financial-data-x-dsf.component.css']
})
export class FinancialDataXDsfComponent implements OnInit {
    ...
    await this.http.post<AppFinDataObjX>(InitAppFinDataUrl, { Id: this.AppId }).toPromise().then(
      (response) => {
        ...
        this.FinDataForm.patchValue({
          GracePeriod: this.appFinDataObj.GracePeriod == null ? 0 : this.appFinDataObj.GracePeriod,
          MrGracePeriodTypeCode: this.appFinDataObj.MrGracePeriodTypeCode == null ? "" : this.appFinDataObj.MrGracePeriodTypeCode,
