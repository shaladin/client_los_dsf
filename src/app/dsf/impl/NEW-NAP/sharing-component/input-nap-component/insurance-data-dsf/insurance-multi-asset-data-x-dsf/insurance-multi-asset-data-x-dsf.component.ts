...
import { UcInsuranceXDsfComponent } from '../uc-insurance-x-dsf/uc-insurance-x-dsf.component';

@Component({
  selector: 'app-insurance-multi-asset-data-x-dsf',
  templateUrl: './insurance-multi-asset-data-x-dsf.component.html'
})
export class InsuranceMultiAssetDataXDsfComponent implements OnInit {
  ...
  @ViewChild(UcInsuranceXDsfComponent) ucInsCom : UcInsuranceXDsfComponent;
