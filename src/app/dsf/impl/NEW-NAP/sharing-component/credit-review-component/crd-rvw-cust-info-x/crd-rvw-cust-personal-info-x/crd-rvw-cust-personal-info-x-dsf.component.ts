...
@Component({
  selector: 'app-crd-rvw-cust-personal-info-x-dsf',
  templateUrl: './crd-rvw-cust-personal-info-x-dsf.component.html'
})
export class CrdRvwCustPersonalInfoXDsfComponent implements OnInit {
  ...
  @Output() ngModelForGroupHistDataX: EventEmitter<any> = new EventEmitter();
  ...
  ClickLinkGroupHistoryData() {
    this.ngModelForGroupHistDataX.emit();
  }
