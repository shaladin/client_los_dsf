...
@Component({
  selector: 'app-new-purchase-order-detail-x-dsf',
  templateUrl: './new-purchase-order-detail-x-dsf.component.html'
})
export class NewPurchaseOrderDetailXDsfComponent implements OnInit {
  urlDetail: string;
  lobCode: string;
  AppId: number;
  AgrmntId: number;
  ...
  Cancel() {
    ...
    AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.NAP_ADM_PRCS_NEW_PO_PAGING_DSF], { "BizTemplateCode": CommonConstant.CFNA });
