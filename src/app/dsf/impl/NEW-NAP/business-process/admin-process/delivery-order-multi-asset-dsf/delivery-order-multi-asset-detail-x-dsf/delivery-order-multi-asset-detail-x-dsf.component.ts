...
import { CreateDoMultiAssetXDsfComponent } from '../create-do-multi-asset-x-dsf/create-do-multi-asset-x-dsf.component';
import { NavigationConstantDsf } from 'app/shared/constant/NavigationConstantDsf';

@Component({
  selector: 'app-delivery-order-multi-asset-detail-x-dsf',
  templateUrl: './delivery-order-multi-asset-detail-x-dsf.component.html',
  styles: []
})
export class DeliveryOrderMultiAssetDetailXDsfComponent implements OnInit {
  appId: number;
  agrmntId: number;
  ...
  showModalDO(formArray: FormArray, mode: string, deliveryOrderHId: number) {
    ...
    const modalCreateDO = this.modalService.open(CreateDoMultiAssetXDsfComponent);
  ...
  Back() {
    // Self Custom Changes CR Runner KTB 398912
    AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.NAP_ADM_PRCS_DO_MULTI_ASSET_PAGING_DSF], { BizTemplateCode: this.bizTemplateCode });
    // End Self Custom Changes CR Runner KTB 398912
  }
