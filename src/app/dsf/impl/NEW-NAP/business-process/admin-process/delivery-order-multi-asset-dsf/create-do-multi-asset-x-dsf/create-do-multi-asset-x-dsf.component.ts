...
import { DoAssetDetailXDsfComponent } from '../do-asset-detail-x-dsf/do-asset-detail-x-dsf.component';

@Component({
  selector: 'app-create-do-multi-asset-x-dsf',
  templateUrl: './create-do-multi-asset-x-dsf.component.html',
  styles: [],
  providers: [NGXToastrService]
})
export class CreateDoMultiAssetXDsfComponent implements OnInit {
  ...
  AssetTempLetterHandler(appAssetId) {
    ...
    const modalDOAppAsset = this.modalServiceAsset.open(DoAssetDetailXDsfComponent);
