...
@Component({
  selector: 'app-delivery-order-multi-asset-dsf',
  templateUrl: './delivery-order-multi-asset-dsf.component.html',
  styles: []
})
export class DeliveryOrderMultiAssetDsfComponent implements OnInit, OnDestroy {
  ...
  SetUcPaging(){
    ...
    if(environment.isCore){
      this.inputPagingObj._url = "./assets/dsf/ucpaging/V2/searchDeliveryOrderMultiAssetV2Dsf.json";
      this.inputPagingObj.pagingJson = "./assets/dsf/ucpaging/V2/searchDeliveryOrderMultiAssetV2Dsf.json";
