...
@Component({
  selector: 'app-change-mou-return-paging-dsf',
  templateUrl: './change-mou-return-paging-dsf.component.html',
  styleUrls: ['./change-mou-return-paging-dsf.component.css']
})
export class ChangeMouReturnPagingDsfComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(environment.isCore){
      this.inputPagingObj._url = "./assets/ucpaging/mou/V2/searchChangeMouReturnV2Dsf.json";
      this.inputPagingObj.pagingJson = "./assets/ucpaging/mou/V2/searchChangeMouReturnV2Dsf.json";
