...
@Component({
  selector: 'app-change-mou-approval-paging-x-dsf',
  templateUrl: './change-mou-approval-paging-x-dsf.component.html',
  styleUrls: ['./change-mou-approval-paging-x-dsf.component.css']
})
export class ChangeMouApprovalPagingXDsfComponent implements OnInit {
