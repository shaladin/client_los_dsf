...
@Component({
  ...
  templateUrl: './mou-request-addcoll-x-dsf.component.html',
  styleUrls: ['./mou-request-addcoll-x-dsf.component.css']
})
export class MouRequestAddcollXDsfComponent implements OnInit {
