...
@Component({
  ...
  templateUrl: './change-mou-request-addcoll-x-dsf.component.html',
  styleUrls: ['./change-mou-request-addcoll-x-dsf.component.css']
})
export class ChangeMouRequestAddcollXDsfComponent implements OnInit {
  ...
  next() {
    ...
    if (this.AddCollDataForm.controls["TotalCollateralActive"].valid && this.AddCollDataForm.controls["Networth"].valid)
    {
      ...
      mouCustDsf.AdjEquity = this.AddCollDataForm.controls.AdjEquity.value;
      mouCustDsf.CeilingCollateral = this.AddCollDataForm.controls.CeilingCollateral.value;
      mouCustDsf.CeilingNetworth = this.AddCollDataForm.controls.CeilingNetworth.value;
      mouCustDsf.DealerEquity = this.AddCollDataForm.controls.DealerEquity.value;
      mouCustDsf.DealerGrading = this.AddCollDataForm.controls.DealerGrading.value;
      mouCustDsf.DealerGradingMultiplier = this.AddCollDataForm.controls.DealerGradingMultiplier.value;
      mouCustDsf.IsCeilingCollateralManual = this.AddCollDataForm.controls.IsCeilingCollateralManual.value;
      mouCustDsf.IsCeilingNetworthManual = this.AddCollDataForm.controls.IsCeilingNetworthManual.value;
      mouCustDsf.IsDealerEquityManual = this.AddCollDataForm.controls.IsDealerEquityManual.value;
      mouCustDsf.IsNetworthManual = this.AddCollDataForm.controls.IsNetworthManual.value;
      mouCustDsf.MouCustId = this.MouCustId;
      mouCustDsf.NetDealerEquity = this.AddCollDataForm.controls.NetDealerEquity.value;
      mouCustDsf.Networth = this.AddCollDataForm.controls.Networth.value;
  ...
  {
    this.AddCollDataForm.patchValue({
      NetDealerEquity: this.AddCollDataForm.controls.DealerEquity.value * this.AddCollDataForm.controls.AdjEquity.value / 100,
