...
@Component({
  selector: 'app-mou-execution-detail-x-dsf',
  templateUrl: './mou-execution-detail-x-dsf.component.html',
  styleUrls: ['./mou-execution-detail-x-dsf.component.css']
})
export class MouExecutionDetailXDsfComponent implements OnInit {
  ...
  Back() {
    AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.MOU_EXECUTION_PAGING_DSF], {MrMouTypeCode : this.MouType});
  }
