...
@Component({
  selector: 'app-change-mou-approval-factoring-x-dsf',
  templateUrl: './change-mou-approval-factoring-x-dsf.component.html',
  styleUrls: ['./change-mou-approval-factoring-x-dsf.component.css']
})
export class ChangeMouApprovalFactoringXDsfComponent implements OnInit {
  ...
  HoldTask(obj) {
    this.http.post(AdInsConstant.ApvHoldTaskUrl, obj).subscribe(
      ...
      (error) => {
        AdInsHelper.RedirectUrl(this.router, [NavigationConstantDsf.CHANGE_MOU_APV_PAGING_DSF], {});
      }
    )
  }
