...
@Component({
  selector: 'app-change-mou-review-factoring-x-dsf',
  templateUrl: './change-mou-review-factoring-x-dsf.component.html',
  styleUrls: ['./change-mou-review-factoring-x-dsf.component.css']
})
export class ChangeMouReviewFactoringXDsfComponent implements OnInit {
      ...
      this.http
        ...
        .subscribe((response) => {
          ...
          AdInsHelper.RedirectUrl(
            this.router,
            [NavigationConstantDsf.CHANGE_MOU_RVW_PAGING_DSF],
            {}
          );
        });
  }
