...
@Component({
  selector: 'app-mou-review-paging-dsf',
  templateUrl: './mou-review-paging-dsf.component.html',
  styleUrls: ['./mou-review-paging-dsf.component.css']
})
export class MouReviewPagingDsfComponent implements OnInit {
  ...
  SetUcPaging() {
    ...
    if(environment.isCore){
      this.inputPagingObj._url = "./assets/ucpaging/V2/searchMouReviewV2Dsf.json";
      this.inputPagingObj.pagingJson = "./assets/ucpaging/V2/searchMouReviewV2Dsf.json";
