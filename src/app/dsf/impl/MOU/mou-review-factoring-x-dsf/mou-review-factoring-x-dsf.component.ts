...
@Component({
  selector: 'app-mou-review-factoring-x-dsf',
  templateUrl: './mou-review-factoring-x-dsf.component.html',
  styleUrls: ['./mou-review-factoring-x-dsf.component.css']
})
export class MouReviewFactoringXDsfComponent implements OnInit {
  ...
  readonly CancelLink: string = NavigationConstantDsf.MOU_CUST_RVW_PAGING_DSF;
