...
@Component({
  ...
  templateUrl: './mou-approval-factoring-x-dsf.component.html',
  styleUrls: ['./mou-approval-factoring-x-dsf.component.css']
})
export class MouApprovalFactoringXDsfComponent implements OnInit {
