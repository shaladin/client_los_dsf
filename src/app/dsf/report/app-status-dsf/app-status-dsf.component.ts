...
@Component({
  selector: 'app-app-status-dsf',
  templateUrl: './app-status-dsf.component.html',
  styleUrls: ['./app-status-dsf.component.css']
})
export class AppStatusDsfComponent implements OnInit {
