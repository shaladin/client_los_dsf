...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    Submenu: [
      ...
      { Path: NavigationConstant.NAP_ADM_PRCS_DO_MULTI_ASSET_PAGING, Title: 'Delivery Order', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CF4W" }] },
      ...
      { Path: NavigationConstant.NAP_ADM_PRCS_INSURANCE_ORDER_PAGING, Title: 'Insurance Order', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CF4W" }] },
      {
        Path: '', Title: 'Additional Process', Icon: '', Class: 'has-sub', Badge: '', BadgeClass: '', IsExternalLink: false,
        Submenu: [
  ...
  },
  {
    ...
    Submenu: [
      ...
      { Path: NavigationConstant.NAP_CRD_PRCS_CRD_APPRV_PAGING, Title: 'Credit Approval', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CFNA" }] },
      ...
      { Path: NavigationConstant.NAP_ADM_PRCS_NAP_DOC_PRINT_PAGING_DSF, Title: 'Document Printing Dsf', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CFNA" }] },
      ...
      Submenu: [
        ...
        { Path: NavigationConstant.NAP_ADD_PRCS_CRD_APPR_RES_EXT_APPRVL_PAGING, Title: 'Credit Approval Result Extension Approval', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CFNA" }] },
  ...
  },
  {
    ...
    Submenu: [
      ...
      { Path: NavigationConstant.NAP_ADM_PRCS_INSURANCE_ORDER_PAGING, Title: 'Insurance Order', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "FL4W" }] },
      {
        Path: '', Title: 'Additional Process', Icon: '', Class: 'has-sub', Badge: '', BadgeClass: '', IsExternalLink: false,
        Submenu: [
          ...
          { Path: NavigationConstant.NAP_ADD_PRCS_CRD_APPR_RES_EXT_APPRVL_PAGING, Title: 'Credit Approval Result Extension Approval', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "FL4W" }] },
  ...
  },
  {
    ...
    Submenu: [
      ...
      { Path: NavigationConstantDsf.NAP_CRD_PRCS_CRD_REVIEW_PAGING, Title: 'Credit Review Dsf', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CFRFN4W" }] },
      { Path: NavigationConstantDsf.NAP_CRD_PRCS_CRD_APPRV_PAGING, Title: 'Credit Approval Dsf', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "CFRFN4W" }] },
  ...
  },
  {
    ...
    Submenu: [
      ...
      { Path: NavigationConstant.NAP_ADD_PRCS_OUTSTANDING_TC_PAGING, Title: 'Outstanding TC', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [{ Attr: "BizTemplateCode", Value: "FCTR" }] },
      {
        Path: '', Title: 'Return Handling', Icon: '', Class: 'has-sub', Badge: '', BadgeClass: '', IsExternalLink: false,
        Submenu: [
      ...
      },
      {
        ...
        Submenu: [
          { Path: NavigationConstantDsf.REPORT_FACT_INVOICE_KWITANSI_TANDATERIMA_PAGING, Title: 'Print Invoice,Kwitansi,Tanda Terima', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: []},
    ...
    Submenu: [
      // { Path: '/Lead/SelfVerification', Title: 'Customer Self Verification', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [] },
      {
        ...
        Submenu: [
          ...
          { Path: NavigationConstant.SIMPLE_LEAD_PAGING_DSF, Title: 'Simple Lead Input Self', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [] },
          ...
          { Path: NavigationConstant.SIMPLE_LEAD_UPD_PAGING_DSF, Title: 'Simple Lead Update Self', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [] },
      ...
      { Path: NavigationConstantDsf.NEW_LEAD_TO_BE_FOLLOW_UP_PAGING, Title: 'New Lead To Be Follow Up', Icon: '', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [] },
  ...
  //  ], Params: []
  //},
  { Path: '', Title: 'Report Dsf', Icon: 'fa fa-print', Class: 'has-sub', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [
  ...
  { Path: '', Title: 'Report', Icon: 'fa fa-print', Class: 'has-sub', Badge: '', BadgeClass: '', IsExternalLink: false, 
    Submenu: [
      ...
      { Path: NavigationConstant.REPORT_DAILY_PENDING_APP_AFT_APV, Title: 'Report Daily Pending Pre Go Live App Aft Apv', Icon: 'fa fa-print', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [] },
      ...
      { Path: NavigationConstant.REPORT_MONTHLY_PRE_GO_LIVE_BY_SUPPLIER, Title: 'Report Monthly Pre Go Live Application By Supplier', Icon: 'fa fa-print', Class: '', Badge: '', BadgeClass: '', IsExternalLink: false, Submenu: [], Params: [] },
