...
@Component({
  selector: 'app-uc-testing2',
  templateUrl: './uc-testing2.component.html',
  styleUrls: ['./uc-testing2.component.scss'],
  animations: [
...
export class UcTesting2Component implements OnInit {
  ...
  apiUrl: string;
  arrCrit: any;
  constructor(private http: HttpClient, private _renderer2: Renderer2, @Inject(DOCUMENT) private _document, public toastr: ToastrService) {
  }
