...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: PathConstant.REPORT_MONTHLY_PRE_GO_LIVE_BY_PRODUCT, component: ReportMonthlyPreGoLiveByProductComponent, data: { title: 'Report Monthly Pre Go Live By Product' } },
