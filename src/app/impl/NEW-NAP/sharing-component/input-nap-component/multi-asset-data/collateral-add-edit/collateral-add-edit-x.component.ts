...
import { LookupCollateralComponent } from 'app/NEW-NAP/sharing-component/input-nap-component/multi-asset-data/collateral-add-edit/lookup-collateral/lookup-collateral.component';
...
@Component({
  selector: 'app-collateral-add-edit-x',
  templateUrl: './collateral-add-edit-x.component.html'
})
export class CollateralAddEditXComponent implements OnInit {
  @Input() AppId: number;
  ...
  back() {
    if (this.isReturnHandlingSave) {
      AdInsHelper.RedirectUrl(this.router, [NavigationConstant.NAP_ADD_PRCS_RETURN_HANDLING_COLL_EDIT_X], { AppId: this.AppId, ReturnHandlingHId: this.ReturnHandlingHId, WfTaskListId: this.WfTaskListId });
      return;
    }
