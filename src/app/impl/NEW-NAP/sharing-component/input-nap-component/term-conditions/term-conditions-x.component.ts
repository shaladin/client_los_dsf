...
@Component({
  selector: 'app-term-conditions-x',
  templateUrl: './term-conditions-x.component.html',
  styleUrls: ['./term-conditions-x.component.css'],
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class TermConditionsXComponent implements OnInit {
