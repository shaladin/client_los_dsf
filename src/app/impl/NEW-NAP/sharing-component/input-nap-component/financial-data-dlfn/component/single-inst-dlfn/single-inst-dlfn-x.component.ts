...
@Component({
  ...
  templateUrl: './single-inst-dlfn-x.component.html'
})
export class SingleInstDlfnXComponent implements OnInit {
            ...
            this.http.post(URLConstant.GetMouCustDlrFindById, { Id: MouCustId }).toPromise().then(
              (responseCustDlfn) => {
                ...
                if (interestType == "PRCNT") {
                  ...
                  if(Days == 0) interestPrcnt = 0; //SITUFCFRTHREE-417 - Fix jika selisih hari = 0, maka rateny
                }
