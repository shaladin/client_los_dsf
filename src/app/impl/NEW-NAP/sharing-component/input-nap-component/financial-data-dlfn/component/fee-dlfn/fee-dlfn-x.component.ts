...
@Component({
  selector: 'app-fee-dlfn-x',
  templateUrl: './fee-dlfn-x.component.html'
})
export class FeeDlfnXComponent implements OnInit {
  ...
  async LoadAppFeeData(AppId: number) {
    ...
    await this.http.post(URLConstantX.GetListAppFeeAndMouFeeByAppIdX, { Id: AppId }).toPromise().then(
      (response) => {
