...
@Component({
  selector: 'app-schm-step-up-step-down-leasing-x',
  templateUrl: './schm-step-up-step-down-leasing-x.component.html',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class SchmStepUpStepDownLeasingXComponent implements OnInit {
  @Input() AppId: number;
