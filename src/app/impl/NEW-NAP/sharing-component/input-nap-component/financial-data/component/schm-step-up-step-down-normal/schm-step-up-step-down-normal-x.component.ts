...
@Component({
  selector: 'app-schm-step-up-step-down-normal-x',
  templateUrl: './schm-step-up-step-down-normal-x.component.html',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class SchmStepUpStepDownNormalXComponent implements OnInit {
  @Input() AppId: number;
