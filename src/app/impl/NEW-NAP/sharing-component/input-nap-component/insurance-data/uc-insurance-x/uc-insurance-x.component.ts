...
@Component({
  selector: 'app-uc-insurance-x',
  templateUrl: './uc-insurance-x.component.html',
  styleUrls: ['./uc-insurance-x.component.css']
})
export class UcInsuranceXComponent implements OnInit {
