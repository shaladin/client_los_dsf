...
@Component({
  selector: 'app-doc-signer-main-info-x',
  templateUrl: './doc-signer-main-info-x.component.html'
})
export class DocSignerMainInfoXComponent implements OnInit {
    ...
    this.http.post(URLConstant.GetAppById, { Id: this.AppId }).subscribe(
      (response: AppObj) => {
        if (this.BizTemplateCode == CommonConstant.CFNA) {
          ...
          this.viewGenericObj.viewInput = "./assets/impl/ucviewgeneric/viewDocSignerFCTRX.json";
        }
        else {
