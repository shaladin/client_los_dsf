...
@Component({
  selector: 'app-job-tab-x',
  templateUrl: './job-tab-x.component.html'
})
export class JobTabXComponent implements OnInit {
  requestedDate: Date;
  ...
  InputLookupEconomicSectorSlikObj: InputLookupObj = new InputLookupObj();
  ...
  async GetData() {
    ...
    await this.http.post(URLConstantX.GetAppCustPersonalJobData, { Id: this.AppCustId }).toPromise().then(
      (response) => {
        this.ReturnAppCustJobDataObj = response['ResAppCustPersonalJobDataAndAddrObj'];
        this.TempRefSectorEconomySlikCode = response['RefSectorEconomySlikCode'];
        if (this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj != null) {
          this.isDataEdit = true;
          this.JobDataForm.patchValue({
            MrProfessionCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.MrProfessionCode,
            IndustryTypeCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.IndustryTypeCode,
            CoyName: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.CoyName,
            MrJobPositionCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.MrJobPositionCode,
            MrJobStatCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.MrJobStatCode,
            MrCoyScaleCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.MrCoyScaleCode,
            EmploymentEstablishmentDt: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.EmploymentEstablishmentDt != null ? formatDate(this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.EmploymentEstablishmentDt, 'yyyy-MM-dd', 'en-US') : "",
            NumOfEmployee: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.NumOfEmployee,
            JobTitleName: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.JobTitleName,
            IsMfEmp: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.IsMfEmp,
            IsWellknownCoy: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.IsWellknownCoy,
            MrWellknownCoyCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.MrWellknownCoyCode,
            MrInvestmentTypeCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.MrInvestmentTypeCode,
            ProfessionalNo: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.ProfessionalNo != "" ? this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.ProfessionalNo : "",
            PrevCoyName: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.PrevCoyName != "" ? this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.PrevCoyName : "",
            PrevEmploymentDt: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.PrevEmploymentDt != null ? datePipe.transform(this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.PrevEmploymentDt, "yyyy-MM-dd") : "",
            OthBizName: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizName != "" ? this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizName : "",
            OthBizType: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizType != "" ? this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizType : "",
            OthBizIndustryTypeCode: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizIndustryTypeCode != "" ? this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizIndustryTypeCode : "",
            OthBizJobPosition: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizJobPosition != "" ? this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizJobPosition : "",
            OthBizEstablishmentDt: this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizEstablishmentDt != null ? datePipe.transform(this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.OthBizEstablishmentDt, "yyyy-MM-dd") : ""
          })
          this.IsWellknownCoy = this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.IsWellknownCoy;
          ...
          if(this.ReturnAppCustJobDataObj.AppCustPersonalJobDataObj.IndustryTypeCode && this.TempRefSectorEconomySlikCode) {
            this.http.post(URLConstantX.GetRefSectorEconomySlikXByCode, {Code: this.TempRefSectorEconomySlikCode}).subscribe(
              (response) => {
                ...
                this.InputLookupEconomicSectorSlikObj.nameSelect = this.ReturnSectorEconomySlikObj.SectorEconomySlikName;
                this.InputLookupEconomicSectorSlikObj.jsonSelect = this.ReturnSectorEconomySlikObj;
              }
            );
          }
        ...
        if (this.ReturnAppCustJobDataObj.JobAddr.AppCustAddrId != 0) {
          this.JobAddrObj = this.ReturnAppCustJobDataObj.JobAddr;
          this.InputJobAddrObj.inputField.inputLookupObj.nameSelect = this.ReturnAppCustJobDataObj.JobAddr.Zipcode;
          this.InputJobAddrObj.inputField.inputLookupObj.jsonSelect = { Zipcode: this.ReturnAppCustJobDataObj.JobAddr.Zipcode };
          this.InputJobAddrObj.default = this.JobAddrObj;
          this.JobDataAddrObj.RowVersion = this.ReturnAppCustJobDataObj.JobAddr.RowVersion;
          this.JobDataForm.patchValue({
            JobNotes: this.JobAddrObj.Notes
          });
        }

        if (this.ReturnAppCustJobDataObj.PrevJobAddr.AppCustAddrId != 0) {
          this.PrevJobAddrObj = this.ReturnAppCustJobDataObj.PrevJobAddr;
          this.InputPrevJobAddrObj.inputField.inputLookupObj.nameSelect = this.ReturnAppCustJobDataObj.PrevJobAddr.Zipcode;
          this.InputPrevJobAddrObj.inputField.inputLookupObj.jsonSelect = { Zipcode: this.ReturnAppCustJobDataObj.PrevJobAddr.Zipcode };
          this.InputPrevJobAddrObj.default = this.PrevJobAddrObj;
          this.PrevJobDataAddrObj.RowVersion = this.ReturnAppCustJobDataObj.PrevJobAddr.RowVersion;
          this.JobDataForm.patchValue({
            PrevJobNotes: this.PrevJobAddrObj.Notes
          });
        }

        if (this.ReturnAppCustJobDataObj.OthBizAddr.AppCustAddrId != 0) {
          this.OthBizAddrObj = this.ReturnAppCustJobDataObj.OthBizAddr;
          this.InputOthBizAddrObj.inputField.inputLookupObj.nameSelect = this.ReturnAppCustJobDataObj.OthBizAddr.Zipcode;
          this.InputOthBizAddrObj.inputField.inputLookupObj.jsonSelect = { Zipcode: this.ReturnAppCustJobDataObj.OthBizAddr.Zipcode };
          this.InputOthBizAddrObj.default = this.OthBizAddrObj;
          this.OthBizDataAddrObj.RowVersion = this.ReturnAppCustJobDataObj.OthBizAddr.RowVersion;
          this.JobDataForm.patchValue({
  ...
  SubmitData() {
    ...
    let reqAppCustPersonalJobDataObjX = {
  ...
  SetCriteriaAndRequired(CustModelCode: string, isChange: boolean = false) {
    ...
    this.InputLookupEconomicSectorSlikObj.nameSelect = "";
    this.InputLookupEconomicSectorSlikObj.jsonSelect = { RefSectorEconomySlikName: "" };
  ...
  async InitLookup() {
    ...
    this.InputLookupEconomicSectorSlikObj.urlJson = "./assets/impl/uclookup/NAP/lookupRefSectorEconomySlikX.json";
    this.InputLookupEconomicSectorSlikObj.urlEnviPaging = environment.FoundationR3Url + "/v1";
    this.InputLookupEconomicSectorSlikObj.pagingJson = "./assets/impl/uclookup/NAP/lookupRefSectorEconomySlikX.json";
    this.InputLookupEconomicSectorSlikObj.genericJson = "./assets/impl/uclookup/NAP/lookupRefSectorEconomySlikX.json";
    ...
    this.InputLookupEconomicSectorSlikObj.isReady = true;
  }
