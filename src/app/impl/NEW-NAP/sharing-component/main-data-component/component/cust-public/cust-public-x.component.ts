...
import { ShareholderPublicObj } from 'app/shared/model/app-cust/shareholder/shareholder-public-obj.model';
...
@Component({
  ...
  templateUrl: './cust-public-x.component.html',
})
export class CustPublicXComponent implements OnInit {
