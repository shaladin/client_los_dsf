...
@Component({
  selector: 'app-doc-signer-detail-x',
  templateUrl: './doc-signer-detail-x.component.html'
})

export class DocSignerDetailXComponent implements OnInit {
  ...
  readonly CanceLink: string = NavigationConstant.NAP_ADM_PRCS_NAP_FCTR_DOC_SIGNER_PAGING;
