...
@Component({
  selector: 'app-end-date-go-live-approval-detail-x',
  templateUrl: './end-date-go-live-approval-detail-x.component.html'
})
export class EndDateForGoLiveApprovalDetailXComponent implements OnInit {
  viewObj: string;
  TrxNo: string;
  AgrmntNo: string;
  result: AgrmntObj;
  ...
  onApprovalSubmited(event) {
    ...
    this.http.post(URLConstantX.EndDateGoLiveApprovalX, ReqPreGoLiveApvCustomObj).subscribe(
      () => {
