...
@Component({
  selector: 'app-credit-approval-result-extension-approval-detail-x',
  templateUrl: './detail-x.component.html',
})
export class CreditApprovalResultExtensionApprovalDetailXComponent implements OnInit {
  ...
  onApprovalSubmited(event)
  {
    ...
    this.http.post(URLConstantX.ResultExpiredDaysApprovalX, ReqCrApvResExpCustomObj).subscribe(
      () => {
