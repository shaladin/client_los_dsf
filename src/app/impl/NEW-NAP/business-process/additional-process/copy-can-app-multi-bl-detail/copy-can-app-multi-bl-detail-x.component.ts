...
@Component({
  ...
  templateUrl: './copy-can-app-multi-bl-detail-x.component.html'
})
export class CopyCanAppMultiBlDetailXComponent implements OnInit {
  ...
  SaveForm() {
    ...
    let urlPost = environment.isCore ? URLConstantX.AddAppFromCopyCancledAppV2 : URLConstantX.AddAppFromCopyCancledApp; 
