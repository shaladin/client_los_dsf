...
@Component({
  selector: 'app-return-handling-collateral-paging-x',
  templateUrl: './return-handling-collateral-paging-x.component.html',
})
export class ReturnHandlingCollateralPagingXComponent implements OnInit, OnDestroy {
  ...
  async SetUcPaging() {
    ...
    if (environment.isCore) {
      ...
      this.inputPagingObj._url = "./assets/ucpaging/V2/searchReturnHandlingCollateralV2X.json";
      this.inputPagingObj.pagingJson = "./assets/ucpaging/V2/searchReturnHandlingCollateralV2X.json";
  ...
  async GetCallBack(ev) {
    if (ev.Key == "Edit") {
      ...
      AdInsHelper.RedirectUrl(this.router, [NavigationConstant.NAP_ADD_PRCS_RETURN_HANDLING_COLL_EDIT_X], { "AppId": ev.RowObj.AppId, "WfTaskListId": wfTaskListIdTemp, "ReturnHandlingHId": ev.RowObj.ReturnHandlingHId });
    }
