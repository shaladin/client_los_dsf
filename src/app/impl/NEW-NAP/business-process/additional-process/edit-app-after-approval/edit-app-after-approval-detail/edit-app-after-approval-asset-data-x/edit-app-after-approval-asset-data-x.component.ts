...
@Component({
  selector: 'app-edit-app-after-approval-asset-data-x',
  templateUrl: './edit-app-after-approval-asset-data-x.component.html',
  styleUrls: ['./edit-app-after-approval-asset-data-x.component.css']
})
export class EditAppAfterApprovalAssetDataXComponent implements OnInit {
