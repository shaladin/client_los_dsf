...
@Component({
  selector: 'app-edit-app-after-approval-approval-detail-x',
  templateUrl: './edit-app-after-approval-approval-detail-x.component.html'
})
export class EditAppAfterApprovalApprovalDetailXComponent implements OnInit {
