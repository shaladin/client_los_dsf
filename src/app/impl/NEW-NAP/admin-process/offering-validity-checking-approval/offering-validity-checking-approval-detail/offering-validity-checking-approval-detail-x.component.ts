...
@Component({
  selector: 'app-offering-validity-checking-approval-detail-x',
  templateUrl: './offering-validity-checking-approval-detail-x.component.html'
})
export class OfferingValidityCheckingApprovalDetailXComponent implements OnInit {
  ...
  onApprovalSubmited(event) {
    ...
    this.http.post(URLConstantX.CreditApprovalX, reqApvCustomObj).subscribe(
      (response) => {
