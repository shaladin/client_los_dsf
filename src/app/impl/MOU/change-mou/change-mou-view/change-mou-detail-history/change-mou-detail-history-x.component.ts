...
@Component({
  selector: 'app-change-mou-detail-history-x',
  templateUrl: './change-mou-detail-history-x.component.html'
})
export class ChangeMouDetailHistoryXComponent implements OnInit {
