...
@Component({
  selector: 'app-change-mou-addcoll-history-x',
  templateUrl: './change-mou-addcoll-history-x.component.html'
})
export class ChangeMouAddcollHistoryXComponent implements OnInit {
