...
@Component({
  selector: "app-change-mou-request-detail-customer-x",
  templateUrl: "./change-mou-request-detail-customer-x.component.html",
  providers: [NGXToastrService],
})
export class ChangeMouRequestDetailCustomerXComponent
