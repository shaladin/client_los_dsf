...
@Component({
  selector: "app-mou-unfreeze-apv-detail-x",
  templateUrl: "./mou-unfreeze-apv-detail-x.component.html",
  styles: [],
})

export class MouUnfreezeApvDetailXComponent implements OnInit {
  TrxId: number;
  TrxNo: string;
  taskId: number;
  instanceId: number;
