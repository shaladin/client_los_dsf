...
import { MouCustAssetComponent } from 'app/MOU/mou-customer-request/mou-detail-general/mou-cust-asset/mou-cust-asset.component';
...
@Component({
  selector: 'app-mou-detail-general-x',
  templateUrl: './mou-detail-general-x.component.html'
})
export class MouDetailGeneralXComponent implements OnInit {
