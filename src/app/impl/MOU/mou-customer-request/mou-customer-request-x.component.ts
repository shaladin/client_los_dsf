...
@Component({
  selector: 'app-mou-customer-request-x',
  templateUrl: './mou-customer-request-x.component.html',
  styleUrls: [],
  providers: [NGXToastrService]
})
export class MouCustomerRequestXComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.MrMouTypeCode != "FACTORING") {
      ...
      this.inputPagingObj._url = "./assets/impl/ucpaging/searchMouCustomerRequestFactoringX.json";
      this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchMouCustomerRequestFactoringX.json";
    }
