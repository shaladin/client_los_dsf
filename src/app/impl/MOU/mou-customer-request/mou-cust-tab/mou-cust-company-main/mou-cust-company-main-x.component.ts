...
@Component({
  selector: 'app-mou-cust-company-main-x',
  templateUrl: './mou-cust-company-main-x.component.html',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})

export class MouCustCompanyMainXComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.parentForm.addControl(this.identifier, this.fb.group({
      ...
      TaxIdNo: ['', [Validators.required, Validators.maxLength(50), Validators.pattern("^[0-9]+$"), Validators.minLength(16), Validators.maxLength(16)]],
      IsVip: [false]
    }));
