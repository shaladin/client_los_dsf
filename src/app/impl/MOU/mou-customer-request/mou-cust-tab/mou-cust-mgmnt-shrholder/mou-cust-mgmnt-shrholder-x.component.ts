...
@Component({
  selector: 'app-mou-cust-mgmnt-shrholder-x',
  templateUrl: './mou-cust-mgmnt-shrholder-x.component.html',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})

export class MouCustMgmntShrholderXComponent implements OnInit {
  ...
  npwpKtpChecking(){
    ...
    if (this.CustShareholderForm.controls.MrCustTypeCode.value == CommonConstant.CustTypePersonal){
      if(this.npwpOrKtp.includes(this.CustShareholderForm.controls.MrIdTypeCode.value)){
