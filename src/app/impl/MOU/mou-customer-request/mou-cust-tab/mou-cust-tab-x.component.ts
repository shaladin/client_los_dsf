...
import { MouCustPersonalMainComponent } from 'app/MOU/mou-customer-request/mou-cust-tab/mou-cust-personal-main/mou-cust-personal-main.component';
import { MouCustPersonalContactInfoComponent } from 'app/MOU/mou-customer-request/mou-cust-tab/mou-cust-personal-contact-info/mou-cust-personal-contact-info.component';
import { MouCustJobDataComponent } from 'app/MOU/mou-customer-request/mou-cust-tab/mou-cust-job-data/mou-cust-job-data.component';
import { MouCustGrpMbrComponent } from 'app/MOU/mou-customer-request/mou-cust-tab/mou-cust-grp-mbr/mou-cust-grp-mbr.component';
...
export class MouCustTabXComponent implements OnInit {
  ...
  initAddrLegalObj() {
    ...
    this.inputAddrLegalPersonalObj.title = 'Legal Address';
  ...
  readonly identifierPersonalMain = 'PersonalMain'
