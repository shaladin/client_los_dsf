...
@Component({
  selector: 'app-mou-cust-personal-main-x',
  templateUrl: './mou-cust-personal-main-x.component.html',
  viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }],
  providers: [RegexService]
})

export class MouCustPersonalMainXComponent implements OnInit {
  ...
  async ngOnInit(): Promise<void> {
    ...
    this.parentForm.addControl(this.identifier, this.fb.group({
      ...
      TaxIdNo: ['', [Validators.maxLength(50), Validators.pattern("^[0-9]+$"), Validators.minLength(16), Validators.maxLength(16)]],
      ...
      IsVip: [false],
      Email1: ['', [Validators.required, Validators.maxLength(100), Validators.pattern(CommonConstant.regexEmail)]],
  ...
  npwpKtpChecking(){
    console.log(this.parentForm.controls[this.identifier]['controls'].MrIdTypeCode.value)
    if(this.npwpOrKtp.includes(this.parentForm.controls[this.identifier]['controls'].MrIdTypeCode.value)){
  ...
  clearExpDt() {
    ...
    if (this.parentForm.controls[this.identifier]['controls'].MrIdTypeCode.value == this.MrIdTypeCodeNPWP) {
      ...
      this.parentForm.controls[this.identifier]['controls'].TaxIdNo.setValidators([Validators.maxLength(50), Validators.pattern("^[0-9]+$"), Validators.minLength(16), Validators.maxLength(16)]);
      this.parentForm.controls[this.identifier]['controls'].TaxIdNo.updateValueAndValidity();
    }
