...
@Component({
  selector: 'app-prod-offering-apv-detail-x',
  templateUrl: './prod-offering-apv-detail-x.component.html'
})
export class ProdOfferingApvDetailXComponent implements OnInit {
