...
@Component({
  selector: 'app-prod-offering-deact-apv-detail-x',
  templateUrl: './prod-offering-deact-apv-detail-x.component.html'
})
export class ProdOfferingDeactApvDetailXComponent implements OnInit {
  TaskId: number;
  ApvReqId: number;
  ...
  onApprovalSubmited(event) {
    ...
    this.http.post(URLConstantX.ProdOfferingApproval, reqProdHoApvCustomObj).subscribe(
      (response) => {
