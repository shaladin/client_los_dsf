...
@Component({
  selector: 'app-prod-ho-deact-apv-detail-x',
  templateUrl: './prod-ho-deact-apv-detail-x.component.html'
})
export class ProdHoDeactApvDetailXComponent implements OnInit {
