...
@Component({
  selector: 'app-prod-ho-return-paging-x',
  templateUrl: './prod-ho-return-paging-x.component.html'
})
export class ProdHoReturnPagingXComponent implements OnInit {
  ...
  EditButtonClick(e) {
    if (e.RowObj.DraftProdHId == null) {
      AdInsHelper.RedirectUrl(this.router, [NavigationConstant.PRODUCT_HO_ADD_X], { "ProdHId": e.RowObj.CurrentProdHId, "mode": "edit", "source": "return" });
    }
    else {
      AdInsHelper.RedirectUrl(this.router, [NavigationConstant.PRODUCT_HO_ADD_X], { "ProdHId": e.RowObj.DraftProdHId, "mode": "edit", "source": "return" });
    }
  }
}
