...
@Component({
  selector: 'app-trusting-social-view-header-x',
  templateUrl: './trusting-social-view-header-x.component.html',
})
export class TrustingSocialViewHeaderXComponent implements OnInit {
