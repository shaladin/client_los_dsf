...
import { LeadCustPersonalFinDataObj } from 'app/shared/model/lead-cust-personal-fin-data-obj.model';
...
export class NewLeadInputCustDataXComponent implements OnInit {
  @Input() LeadId: number;
