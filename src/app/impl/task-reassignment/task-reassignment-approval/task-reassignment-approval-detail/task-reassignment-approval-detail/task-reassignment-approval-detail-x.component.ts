...
@Component({
  selector: 'app-task-reassignment-approval-detail-x',
  templateUrl: './task-reassignment-approval-detail-x.component.html',
  styles: []
})
export class TaskReassignmentApprovalDetailXComponent implements OnInit {
  ...
  onApprovalSubmited(event) {
    ...
    this.http.post(URLConstantX.TaskReassignmentApproval, ReqTaskReassignmentApvCustomObj).subscribe(
      () => {
