...
@Component({
  selector: 'app-ltkm-return-handling-paging-x',
  templateUrl: './ltkm-return-handling-x.component.html',
  styleUrls: []
})
export class LtkmReturnHandlingPagingXComponent implements OnInit {
  ...
  ngOnInit() {
    this.inputPagingObj._url = "./assets/impl/ucpaging/searchLtkmReturnHandlingX.json";
    this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/searchLtkmReturnHandlingX.json";
    
    if(environment.isCore){
      this.inputPagingObj._url = "./assets/impl/ucpaging/V2/searchLtkmReturnHandlingV2X.json";
      this.inputPagingObj.pagingJson = "./assets/impl/ucpaging/V2/searchLtkmReturnHandlingV2X.json";
