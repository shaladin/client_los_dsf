...
@Component({
    selector: 'app-ltkm-cc-contact-information-x',
    templateUrl: './cc-contact-information-x.component.html',
    providers: [RegexService],
    viewProviders: [{ provide: ControlContainer, useExisting: FormGroupDirective }]
})
export class LtkmCcContactInformationTabXComponent implements OnInit {
