...
@Component({
  selector: 'app-view-ltkm-cust-data-personal-x',
  templateUrl: './view-ltkm-customer-data-personal-x.component.html',
  styleUrls: []
})
export class ViewLtkmCustDataPersonalDataXComponent implements OnInit {
