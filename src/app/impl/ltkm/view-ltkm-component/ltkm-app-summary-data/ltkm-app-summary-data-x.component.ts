...
@Component({
    selector: "view-ltkm-app-summary-data-x",
    templateUrl: "./ltkm-app-summary-data-x.component.html",
    providers: [NGXToastrService]
})

export class ViewLtkmAppSummaryDataXComponent implements OnInit {
        ...
        this.http.post(URLConstant.GetAppSummaryByAppId, { Id: this.AppId }).subscribe(
            (response) => {
                ...
                if (this.SummaryObj.AppIns != null) {
                    this.totalInsPremi = this.SummaryObj.AppIns.TotalInscoMainPremiAmt + this.SummaryObj.AppIns.TotalInscoAddPremiAmt + this.SummaryObj.AppIns.InscoAdminFeeAmt + this.SummaryObj.AppIns.InscoStampDutyFee;
                }
