...
import { LtkmApprovalHistComponent } from 'app/ltkm/view-ltkm-component/ltkm-approval-history-data/ltkm-approval-history-data.component';
import { LtkMainInfoComponent } from 'app/ltkm/ltkm-mi/ltkm-mi.component';

@Component({
  selector: 'app-ltkm-view-x',
  templateUrl: './ltkm-view-component-x.html',
})
export class LtkmViewComponentX implements OnInit {
