...
@Component({
  selector: 'app-change-mou-view-addcoll-history-x',
  templateUrl: './change-mou-view-addcoll-history-x.component.html'
})
export class ChangeMouViewAddcollHistoryXComponent implements OnInit {
