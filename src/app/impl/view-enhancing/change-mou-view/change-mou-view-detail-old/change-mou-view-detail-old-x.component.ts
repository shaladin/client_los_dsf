...
@Component({
  selector: 'app-change-mou-view-detail-old-x',
  templateUrl: './change-mou-view-detail-old-x.component.html'
})
export class ChangeMouViewDetailOldXComponent implements OnInit {
