...
@Component({
  selector: 'app-change-mou-view-detail-history-ver-x',
  templateUrl: './change-mou-view-detail-history-ver-x.component.html',
  providers: [NGXToastrService]
})
export class ChangeMouViewDetailHistoryVerXComponent implements OnInit {
