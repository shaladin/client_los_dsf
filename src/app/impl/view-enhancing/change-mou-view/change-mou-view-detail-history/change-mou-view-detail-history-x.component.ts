...
@Component({
  selector: 'app-change-mou-view-detail-history-x',
  templateUrl: './change-mou-view-detail-history-x.component.html'
})
export class ChangeMouViewDetailHistoryXComponent implements OnInit {
