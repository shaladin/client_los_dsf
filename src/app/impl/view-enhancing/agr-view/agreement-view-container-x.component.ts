...
@Component({
  selector: 'app-agreement-view-container-x',
  templateUrl: './agreement-view-container-x.component.html',
  styleUrls: []
})
export class AgreementViewContainerXComponent implements OnInit {
