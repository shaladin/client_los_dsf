...
@Component({
  selector: 'app-tab-analysis-result-history-x-dsf',
  templateUrl: './tab-analysis-result-history-x-dsf.component.html',
  styleUrls: ['./tab-analysis-result-history-x-dsf.component.css']
})
export class TabAnalysisResultHistoryXDsfComponent implements OnInit {
