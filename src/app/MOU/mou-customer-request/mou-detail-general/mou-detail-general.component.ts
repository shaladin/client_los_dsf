...
export class MouDetailGeneralComponent implements OnInit {
  ...
  constructor(
    ...
    refMasterIntrstType.RefMasterTypeCode = AdInsConstant.RefMasterTypeCodeInterestType;
    ...
    refMasterInstSchm.RefMasterTypeCode = AdInsConstant.RefMasterTypeCodeInstSchm;
    ...
    refMasterFirstInst.RefMasterTypeCode = AdInsConstant.RefMasterTypeCodeFirstInstType;
