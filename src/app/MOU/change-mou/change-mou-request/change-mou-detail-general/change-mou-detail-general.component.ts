...
export class ChangeMouDetailGeneralComponent implements OnInit {
  ...
  MouDetailGeneralForm = this.fb.group({
    ...
    MrFirstInstTypeCode: [''],
    PayFreqCode: [''],
    DownPaymentFromPrcnt: [0, [Validators.required, Validators.min(0), Validators.max(100)]],
    DownPaymentToPrcnt: [0, [Validators.required, Validators.min(0), Validators.max(100)]],
