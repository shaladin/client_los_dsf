...
@Component({
  selector: 'app-tab-deviation-history',
  templateUrl: './tab-deviation-history.component.html',
  styleUrls: []
})
export class TabDeviationHistoryComponent implements OnInit {

  @Input() AppId;
  @Input() IsEditManualDeviation: boolean = false;
