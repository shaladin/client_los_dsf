...
@Component({
  selector: 'app-change-mou-view-addcoll-history',
  templateUrl: './change-mou-view-addcoll-history.component.html'
})
export class ChangeMouViewAddcollHistoryComponent implements OnInit {
