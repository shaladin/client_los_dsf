...
@Component({
  selector: 'app-change-mou-view-detail-history',
  templateUrl: './change-mou-view-detail-history.component.html'
})
export class ChangeMouViewDetailHistoryComponent implements OnInit {
