...
export const environment = {
    ...
    losUrl: 'http://r3app-server.ad-ins.com/1.4.16/LOS',
    FoundationR3Url: 'http://r3app-server.ad-ins.com/1.4.16/FOUNDATION',
    ...
    ApprovalR3Url: 'http://r3app-server.ad-ins.com/1.4.16/APPROVAL_R3_BE',
    ApprovalR3OplUrl: 'http://r3impl-appsvr.ad-ins.com/APPROVAL_OPL_BE_R3/',
    FoundationR3Web: 'http://r3web-server.ad-ins.com/1.4.16/FOUNDATION',
    losR3Web: 'http://r3web-server.ad-ins.com/1.4.16/LOS',
