...
export const environment = {
  ...
  losUrl: 'http://r3app-server.ad-ins.com/LOS_SIT_CY5',
  ...
  losR3Web: 'http://r3web-server.ad-ins.com/LOS_SIT_CY5',
  WorkflowR3Url: 'http://R3App-Server.ad-ins.com/WORKFLOW_SIT_CY5',
