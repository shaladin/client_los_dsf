import { Component, Input, ContentChild, ViewChild, EventEmitter, Output, NgZone, Renderer2, forwardRef } from '@angular/core';
...
import { hasObservers, defined } from '../utils';
...
export class ContextMenuComponent extends MenuBase {
    ...
    showContextMenu(e, element) {
        ...
        if (filter) {
            const currentTarget = this.currentTarget = findInContainer(e.target, filter, element);
